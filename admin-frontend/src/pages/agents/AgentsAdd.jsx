...
import { addAgent } from './AgentsAPI';
import './Agents.css';
        ...
        if (mr_ms === '' || telephone === '' || email === '' || salary === '') {
            ...
            addAgent(formData)
                ...
                .catch((error) => {
                    ...
                    setError('There was an error creating the agent! Please check the console for details.');
                });
        }
    };
    ...
    return (
        <>
            <section>
                <div className="App">
                    <main>
                        <Header title="Add Agent" subtitle="LifeQuest's agents" />
