...
import { getUserAgeBins } from './lifequestDataAPI'; // Import the function to fetch real data
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (account && account.id) {
                try {
                    const result = await getUserAgeBins(account.id); // Pass the agent ID to fetch data
                    ...
                    if (Array.isArray(result)) {
                        ...
                        const transformedData = result
                            ...
                            .map(item => ({
                                id: item.ageBin, // Changed 'label' to 'id' to match Nivo Pie chart data structure
                                value: item.count,
                            }));
