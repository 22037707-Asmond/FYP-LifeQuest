...
CREATE TABLE `users_agents` (
  ...
  KEY `FK8s0qqqx6r18whv6ar0i8myvjo` (`agents_id`),
  KEY `FK1ql4kt6a9oc49c6rtbg6h2qy7` (`users_id`),
  CONSTRAINT `FK1ql4kt6a9oc49c6rtbg6h2qy7` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FK8s0qqqx6r18whv6ar0i8myvjo` FOREIGN KEY (`agents_id`) REFERENCES `agent` (`id`)
